...
// function buildCrewArray(ids,animal){
...
//   }
// }
// return threeCandidates;

// }
//  newCrew = [] 
//   for (i=0; i < threeCandidates.length; i++){ 
//     for (j=0; j<animals.length; j++){
//        if (animals[j].astronautID === threeCandidates[i]){
//           newCrew.push(animals[j]); 
//        } 
//      } 
//     } 
...
//   for(let j=0; j<threeCandidates.length;j++){
//     if (animal[j].astronautID === threeCandidates[i]){
//       astronauts.push(animal[j].name);
//     }
//   }
// }
// return astronauts
